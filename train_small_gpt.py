...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file', required=True) # Added required argument for training file.
    parser.add_argument('--output-dir', required=True) # Added required argument for output directory.
